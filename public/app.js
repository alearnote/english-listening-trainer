...
function updateModeUI() {
  ...
  $("dictationPanel").classList.toggle(
    "hidden",
    mode !== "dictation"
  );
...
function checkMcq() {
  ...
  $("scoreMsg").textContent =
    correctCount === 3
      ? "Excellent! 内容をよく理解できています。"
      : correctCount === 2
      ? "Good! もう一度聞くとさらに定着します。"
      : correctCount === 1
      ? "スクリプトを確認して、もう一度聞いてみましょう。"
